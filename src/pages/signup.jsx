...
const SignUp = () => {
  ...
  const isFormValid = formFields.name && formFields.email && formFields.college && 
                      formFields.branch && formFields.year && formFields.password && 
                      formFields.confirmPassword && termsAccepted;

  const branches = ['Computer Science', 'Electronics', 'Mechanical', 'Civil', 'IT', 'Other'];
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      onChange={onChangeInput}
                      disabled={isLoading}
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all outline-none disabled:bg-gray-50 appearance-none"
                      required
                    >
