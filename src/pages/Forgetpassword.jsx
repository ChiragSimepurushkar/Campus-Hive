        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Back to Reset
            </button>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600 text-sm">
                ...
                <button type="button" onClick={handleSubmit} className="font-semibold text-indigo-600 hover:text-indigo-700">
                  Resend
                </button>
              </p>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>🔒 Secure password reset • 📧 Check your spam folder if needed</p>
        </div>
      </div>
    </div>
  );
